...
export const experience: Experience[] = [
  {
    ...
    detailedDescription: [
      "Built and maintained Snowflake Cortex semantic models for natural-language querying of enterprise data",
      "Orchestrated dbt pipelines with Airflow for automated data transformation across 50+ models",
      "Prototyped agentic workflows using AWS Bedrock for automated data quality monitoring",
      "Bridged complex SQL logic with Python orchestration for cross-platform data integration",
    ],
  ...
  },
  {
    ...
    detailedDescription: [
      "Designed and deployed ELT pipelines processing large-scale operations datasets with Python and SQL",
      "Built automated Power BI dashboards delivering real-time KPIs to stakeholders",
      "Performed root-cause analysis on production data anomalies, reducing reporting errors",
      "Documented data lineage and transformation logic for cross-team knowledge transfer",
    ],
  ...
  },
  {
    ...
    detailedDescription: [
      "Deployed and configured AV equipment across 30+ lecture halls and seminar rooms",
